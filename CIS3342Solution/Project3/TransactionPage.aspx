<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransactionPage.aspx.cs" Inherits="Project3.TransactionPage" %>
        ...
        <div id="wrapper" class="container">
            <fieldset>
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label" for="txtFirstName">Card Number:</label>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtCardNumber" runat="server" class="form-control input-md"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-4 control-label" for="txtLastName">Verification Code:</label>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtVerfCode" runat="server" class="form-control input-md"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-4 control-label" for="txtLastName">Amount:</label>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtAmount" runat="server" class="form-control input-md"></asp:TextBox>
                    </div>


                    <div class="form-group">
                        <asp:Label ID="lblResponse" runat="server" Text="" CssClass="control-label"></asp:Label>
                    </div>
                </div>
                <br />
                <br />
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <asp:Label ID="Label1" runat="server" Text="Apply for a New Card:" CssClass="control-label"></asp:Label>
                            <asp:Button ID="btnAdd" runat="server" Text="Add" OnClick="btnAdd_Click" />
                            <br />
                            <br />
                            <asp:Label ID="lblUpdate" runat="server" Text="Update Billing Address:" CssClass="control-label"></asp:Label>
                            <asp:Button ID="btnUpdate" runat="server" Text="Update" OnClick="btnUpdate_Click" />
                            <asp:Label ID="lblRemove" runat="server" Text="Remove Account:" CssClass="control-label"></asp:Label>
